$(document).ready(function () {
    ...
    var A7 =
        "Los tres psicólogos iniciadores de la Psicología de la Gestalt fueron: Max Wertheimer, Wolfgang Köhler y Kurt Koffka, quienes desarrollaron las primeras investigaciones de la Gestalt a principios de la década de 1910. Estos investigadores trabajaron sobre el movimiento aparente dando lugar a la teoría del fenómeno phi. Este fenómeno hace alusión a una ilusión óptica de nuestro cerebro. El fenómeno phi fue desarrollado previamente por Kurt Lewin en 1826. Este fenómeno permite explicar por qué percibimos el movimiento continuo en donde hay una sucesión de imágenes.";
    var A8 =
    ...
    var B2 =
        "A finales del siglo XIX se descubrió que, al descomponer la luz del Sol, se podían observar multitud de líneas de espectro. Experimentos con gases calientes mostraron que las mismas líneas podían ser observadas en el espectro de los gases, líneas específicas correspondientes a diferentes elementos químicos. De esta manera se demostró que los elementos químicos en el Sol (mayoritariamente hidrógeno) podían encontrarse igualmente en la Tierra. De hecho, el helio fue descubierto primero en el espectro del Sol y solo más tarde se encontró en la Tierra.";
    var B3 =
