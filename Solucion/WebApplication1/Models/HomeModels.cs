namespace Comprension.Models
{
    public class Sujeto
    {
        ...
        public int Puntaje_DD { get; set; }
        public int DD_TR { get; set; }

        //Dígito-Letra
        public string Respuesta_DL { get; set; }
        public int Puntaje_DL { get; set; }
        public int DL_TR { get; set; }
        ...
        public int A1_TR { get; set; }
        public int A2_TR { get; set; }
        public int A3_TR { get; set; }
        public int A4_TR { get; set; }
        public int A5_TR { get; set; }
        public int A6_TR { get; set; }
        public int A7_TR { get; set; }
        public int A8_TR { get; set; }
        public int A9_TR { get; set; }
        public int A10_TR { get; set; }
        public int A11_TR { get; set; }
        public int A12_TR { get; set; }
        public int A13_TR { get; set; }
        public int A14_TR { get; set; }
        public int A15_TR { get; set; }

        public int B1_TR { get; set; }
        public int B2_TR { get; set; }
        public int B3_TR { get; set; }
        public int B4_TR { get; set; }
        public int B5_TR { get; set; }
        public int B6_TR { get; set; }
        public int B7_TR { get; set; }
        public int B8_TR { get; set; }
        public int B9_TR { get; set; }
        public int B10_TR { get; set; }
        public int B11_TR { get; set; }
        public int B12_TR { get; set; }
        public int B13_TR { get; set; }
        public int B14_TR { get; set; }
        public int B15_TR { get; set; }

        //Comprensión
        public int Lectura_A_TR { get; set; }
        public int Lectura_B_TR { get; set; }
        public int Cuestionario_A_TR { get; set; }
        public int Cuestionario_B_TR { get; set; }
        public string Comprension_Orden_de_Presentacion { get; set; }
        public int Puntaje_A_Comprension { get; set; }
        public int Puntaje_B_Comprension { get; set; }
        public string Comprension_A1 { get; set; }
        public string Comprension_A2 { get; set; }
        public string Comprension_A3 { get; set; }
        public string Comprension_A4 { get; set; }
        public string Comprension_A5 { get; set; }
        public string Comprension_A6 { get; set; }
        public string Comprension_A7 { get; set; }
        public string Comprension_A8 { get; set; }
        public string Comprension_A9 { get; set; }
        public string Comprension_A10 { get; set; }
        public string Comprension_B1 { get; set; }
        public string Comprension_B2 { get; set; }
        public string Comprension_B3 { get; set; }
        public string Comprension_B4 { get; set; }
        public string Comprension_B5 { get; set; }
        public string Comprension_B6 { get; set; }
        public string Comprension_B7 { get; set; }
        public string Comprension_B8 { get; set; }
        public string Comprension_B9 { get; set; }
        public string Comprension_B10 { get; set; }
    }
}
